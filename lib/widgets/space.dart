...
class Space {
  ...
  static const vSmall = SizedBox(height: 8);
  static const vSmallest = SizedBox(height: 4);
  static const vMedium = SizedBox(height: 16);
  static const vLarge = SizedBox(height: 32);
  static const vLargest = SizedBox(height: 64);
