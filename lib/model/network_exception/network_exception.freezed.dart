...
mixin _$NetworkException {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(int? code) unauthorizedRequest,
    required TResult Function(int? code) badRequest,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(int? code)? unauthorizedRequest,
    TResult? Function(int? code)? badRequest,
...
class _$UnauthorizedRequestImpl
  ...
  const _$UnauthorizedRequestImpl({this.code});
  ...
  @override
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'NetworkException.unauthorizedRequest(code: $code)';
  }
  ...
  TResult when<TResult extends Object?>({
    ...
    return unauthorizedRequest(code);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return unauthorizedRequest?.call(code);
  }
...
abstract class UnauthorizedRequest implements NetworkException {
  const factory UnauthorizedRequest({final int? code}) =
...
class _$BadRequestImpl with DiagnosticableTreeMixin implements BadRequest {
  const _$BadRequestImpl({this.code});
  ...
  @override
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'NetworkException.badRequest(code: $code)';
  }
...
abstract class BadRequest implements NetworkException {
  const factory BadRequest({final int? code}) = _$BadRequestImpl;
